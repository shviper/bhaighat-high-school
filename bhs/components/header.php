                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
                            ...
                            <span class="badge light text-white bg-primary rounded-circle">00</span>
                        </a>
                    </li>
                    <li class="nav-item dropdown notification_dropdown">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link bell bell-link" href="javascript:void(0);">
                            ...
                            <span class="badge light text-white bg-primary rounded-circle" id="total_message"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $webName . '/bhs/auth/logout.php' ?>" class="btn btn-primary d-sm-inline-block d-none">LogOut <i class="fa-solid fa-right-from-bracket"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
