                            ...
                            ?>
                                    ...
                                    ?>
                                        <div class="col-md-4 col-lg-3 col-sm-12 pdvcdse">
                                            <a class="parent-container pgtdn" href="<?php echo $webName ?>/img/gallery/photo/<?php echo $row["file"] ?>"><img src="<?php echo $webName ?>/img/gallery/photo/<?php echo $row["file"] ?>" class="attachment-250xauto size-250xauto wp-post-image" alt="" decoding="async" loading="lazy" sizes="(max-width: 250px) 100vw, 250px" width="250" height="167">
